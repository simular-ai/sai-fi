...
The repo CI runs the same assemble + unit-test gate — 321 JVM tests, including the string goldens that
pin every line the concierge speaks or shows byte for byte, the 59-scenario FSM golden catalog, and the
